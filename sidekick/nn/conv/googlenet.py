...
class GoogLeNet:
    ...
    @staticmethod
    def build(width, height, depth, classes, reg= 0.0003):
        ...
        x = GoogLeNet.inception_module(x=x, k1=256, k1_3=512, k3=768, k1_5=128, k5=256, k1_pool=128,
        ...
        x= Dropout(0.3, name="Layer19_drop")(x)
